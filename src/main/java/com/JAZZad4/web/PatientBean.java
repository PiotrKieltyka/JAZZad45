package com.JAZZad4.web;

import com.JAZZad4.domain.Patient;
import com.JAZZad4.service.PatientRepository;
...
public class PatientBean implements Serializable {  
    ...
    public void compareBirthdatePesel(ComponentSystemEvent event) {
        try {        
            ...
            String birthdate = UIbirthDate.getValue().toString().substring(26, 28);
